          ...
          <div className="flex flex-col justify-center items-center gap-[25px]">
            ...
            <div className="flex items-center gap-5">
              <button
                ...
                className="bg-[#6366f1] text-white capitalize px-[10px] md:px-[30px] py-[15px] font-bold rounded-lg border border-[#6366f1] hover:bg-transparent hover:text-[#6366f1] transition-all ease-in-out duration-300"
              >
                connect wallet
              </button>
              <button
